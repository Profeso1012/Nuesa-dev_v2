      ...
      <section className="w-full py-16">
        <div className="max-w-7xl mx-auto px-6 md:px-24">
          ...
          <div className="flex items-center justify-center gap-3 mt-8">
            <div
              className={`h-3 rounded-full transition-all ${leadersIndex === 0 ? "w-12 bg-[#E6731F]" : "w-3 bg-[#C45D16] opacity-40"}`}
            />
            <div
              className={`h-3 rounded-full transition-all ${leadersIndex === 1 ? "w-12 bg-[#E6731F]" : "w-3 bg-[#C45D16] opacity-40"}`}
            />
            <div
              className={`h-3 rounded-full transition-all ${leadersIndex === 2 ? "w-12 bg-[#E6731F]" : "w-3 bg-[#C45D16] opacity-40"}`}
            />
          </div>
        </div>
      </section>
