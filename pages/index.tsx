      ...
      <section className="w-full bg-[#793D14] text-white">
        <div className="max-w-7xl mx-auto px-6 md:px-24 py-12 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <input aria-label="email" placeholder="Enter your email" className="px-3 py-2 rounded text-black" />
            <button className="bg-[#E6731F] px-4 py-2 rounded text-white">Subscribe Now</button>
          </div>
        </div>
      </section>
