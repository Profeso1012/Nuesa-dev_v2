  ...
  const lecturers = [
    {
      ...
      courses: [
        'MEE 205 [Thermodynamics]',
        'MEE 305 [Fluid Mechanics]',
        'MEE 405 [Heat Transfer]',
        'MEE 205 [Machine Design]',
        'MEE 305 [Dynamics]',
        'MEE 405 [Manufacturing]',
        'MEE 505 [Robotics]',
      ],
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-24">
          <div className="flex flex-col items-center gap-5">
            <h1 className="text-3xl md:text-4xl font-medium text-center">
              Department of <span className="text-[#C45D16]">Mechanical Engineering</span>
            </h1>
            <p className="text-lg md:text-xl text-[#212121] text-center max-w-5xl leading-relaxed">
              Focused on the design, analysis, and manufacturing of mechanical systems, the Department of Mechanical Engineering provides students with comprehensive training in thermodynamics, fluid mechanics, machine design, and manufacturing processes. Students gain hands-on experience that shapes innovators who build the technologies that drive industries and advance society.
            </p>
          </div>
        </div>
      </section>
