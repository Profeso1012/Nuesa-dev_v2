  ...
  const lecturers = [
    {
      ...
      courses: [
        'INE 205 [Operations Research]',
        'INE 305 [Production Planning]',
        'INE 405 [Quality Control]',
        'INE 205 [Work Study]',
        'INE 305 [Ergonomics]',
        'INE 405 [Supply Chain]',
        'INE 505 [Project Management]',
      ],
    },
    {
      name: 'Dr Olofinkua Joseph',
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-24">
          <div className="flex flex-col items-center gap-5">
            <h1 className="text-3xl md:text-4xl font-medium text-center">
              Department of <span className="text-[#C45D16]">Industrial Engineering</span>
            </h1>
            <p className="text-lg md:text-xl text-[#212121] text-center max-w-5xl leading-relaxed">
              Focused on optimizing systems, processes, and resources for maximum efficiency and productivity. The department equips students with analytical, managerial, and technical skills to design smarter workflows and improve performance across industries.
            </p>
          </div>
        </div>
      </section>
