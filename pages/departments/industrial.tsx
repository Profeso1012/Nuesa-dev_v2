        ...
        <div className="max-w-7xl mx-auto px-6 md:px-24">
          <div className="flex flex-col items-center gap-5">
            ...
            <p className="text-lg md:text-xl text-[#212121] text-center max-w-5xl leading-relaxed">
              The Department of {deptName} focuses on optimizing systems, processes, and organizations through rigorous analysis and design. Our curriculum covers operations research, production planning, quality control, and supply chain management. We develop leaders who drive efficiency, innovation, and competitive advantage in organizations worldwide.
            </p>
          </div>
        </div>
      </section>
