...
export default function ElectronicsComputerDepartment() {
  ...
  const dept = 'electronics-computer';
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-24">
          <div className="flex flex-col items-center gap-5">
            ...
            <p className="text-lg md:text-xl text-[#212121] text-center max-w-5xl leading-relaxed">
              The Department of {deptName} prepares students to design and develop cutting-edge technologies in digital systems, microprocessors, embedded systems, and communications. Our program combines theoretical knowledge with practical experience to develop engineers who innovate in the rapidly evolving electronics and computing fields.
            </p>
          </div>
        </div>
      </section>
