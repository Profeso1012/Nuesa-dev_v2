  ...
  const lecturers = [
    {
      ...
      courses: [
        'ECE 205 [Digital Systems]',
        'ECE 305 [Microprocessors]',
        'ECE 405 [VLSI Design]',
        'ECE 205 [Circuit Analysis]',
        'ECE 305 [Control Systems]',
        'ECE 405 [Communications]',
        'ECE 505 [Embedded Systems]',
      ],
    },
    {
      name: 'Dr Olofinkua Joseph',
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-24">
          <div className="flex flex-col items-center gap-5">
            <h1 className="text-3xl md:text-4xl font-medium text-center">
              Department of <span className="text-[#C45D16]">Electronics & Computer Engineering</span>
            </h1>
            <p className="text-lg md:text-xl text-[#212121] text-center max-w-5xl leading-relaxed">
              Covers the principles of electrical circuits, power systems, and electronics. The department equips students with the skills to design and optimize systems that power modern technology, from telecommunications to embedded systems and computer architecture.
            </p>
          </div>
        </div>
      </section>
