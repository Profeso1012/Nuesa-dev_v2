        ...
        <div className="max-w-7xl mx-auto px-6 md:px-24">
          <div className="flex flex-col items-center gap-5">
            ...
            <p className="text-lg md:text-xl text-[#212121] text-center max-w-5xl leading-relaxed">
              The Department of {deptName} trains engineers to design, build, and maintain infrastructure that serves communities. Our comprehensive curriculum covers structural analysis, geotechnical engineering, hydraulics, and construction management. We develop leaders who build sustainable, resilient infrastructure for the future.
            </p>
          </div>
        </div>
      </section>
