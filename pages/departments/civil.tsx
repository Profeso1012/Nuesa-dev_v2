  ...
  const lecturers = [
    {
      ...
      courses: [
        'CVE 205 [Structural Analysis]',
        'CVE 305 [Concrete Design]',
        'CVE 405 [Steel Structures]',
        'CVE 205 [Surveying]',
        'CVE 305 [Geotechnical]',
        'CVE 405 [Hydraulics]',
        'CVE 505 [Construction]',
      ],
    },
    {
      name: 'Dr Olofinkua Joseph',
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-24">
          <div className="flex flex-col items-center gap-5">
            <h1 className="text-3xl md:text-4xl font-medium text-center">
              Department of <span className="text-[#C45D16]">Civil Engineering</span>
            </h1>
            <p className="text-lg md:text-xl text-[#212121] text-center max-w-5xl leading-relaxed">
              Centers on the planning, design, and construction of infrastructure projects such as roads, bridges, and water systems. The department promotes sustainable development and environmental stewardship, training engineers to build the physical foundation of modern society.
            </p>
          </div>
        </div>
      </section>
