    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: 'Roboto, sans-serif' }}>
      ...
      <section className="w-full py-5" style={{ background: 'rgba(196, 93, 22, 0.20)' }}>
        <div className="w-full overflow-hidden py-4">
          <PartnerDisplay partners={partners} />
        </div>
      </section>
      ...
      <section className="w-full bg-white py-16 lg:py-22">
        <div className="max-w-7xl mx-auto px-6 md:px-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {/* Benefit Card 1 */}
            <div className="bg-white rounded-2xl p-5 flex flex-col gap-4" style={{ boxShadow: '0 2px 8px 0 rgba(0,0,0,0.10), 0 6px 10px 0 rgba(0,0,0,0.08), 0 12px 16px -2px rgba(0,0,0,0.10)' }}>
